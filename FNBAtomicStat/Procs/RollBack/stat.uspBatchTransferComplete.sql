...
/****** Object:  StoredProcedure [stat].[uspBatchTransferComplete]    Script Date: 10/6/2024 9:19:33 AM ******/
SET ANSI_NULLS ON
GO
...
/*
	...
	Example:
		...
		;
		SELECT * FROM [FNBRisk].[dbo].[StatBatch] WHERE StatBatchId = @iBatchId
		;
...
--	UPDATE [FNBRisk].[dbo].[StatBatch] 
	...
	FROM [FNBRisk].[dbo].[StatBatch] AS mb
