...
/****** Object:  StoredProcedure [stat].[uspBatchTransferComplete]    Script Date: 10/6/2024 9:33:24 AM ******/
SET ANSI_NULLS ON
GO
...
/*
	...
	Example:
		...
		;
		SELECT * FROM [KEYRisk].[dbo].[StatBatch] WHERE StatBatchId = @iBatchId
		;
