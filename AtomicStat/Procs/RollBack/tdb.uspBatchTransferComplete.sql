...
/*
	...
	Example:
		...
		DECLARE @iStatBatchLogId int = 30337
			,@iBatchId int = NULL
		;
		EXEC tdb.uspBatchTransferComplete @piStatBatchLogId = @iStatBatchLogId, @piBatchId = @iBatchId
		;
	...
	History:
		2019-11-26 - LSW - Created

*/
ALTER PROCEDURE [tdb].[uspBatchTransferComplete]
	( 
