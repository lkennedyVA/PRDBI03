...
/*
	...
	History:
		2020-07-02 - LSW - Created based upon [t d b].[uspBatchTransferInitiate]

*/
ALTER PROCEDURE [mtb].[uspBatchTransferInitiate]
	( 
...
BEGIN
	...
	EXEC [mtb].[uspBatchStatBatchLogXrefEstablish] @piStatBatchLogId = @iStatBatchLogId, @piBatchId = @iBatchId OUTPUT, @ptiDebug = @tiDebug
	;
	IF @tiDebug > 0 
	BEGIN
	...
	SET @iBatchId = [mtb].[ufnBatchGetByStatBatchLogId]( @iStatBatchLogId )
	;
