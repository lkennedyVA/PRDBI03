...
*/
ALTER PROCEDURE [ftb].[uspBatchTransferInitiate]
	( 
...
BEGIN
	...
	EXEC [ftb].[uspBatchStatBatchLogXrefEstablish] @piStatBatchLogId = @iStatBatchLogId, @piBatchId = @iBatchId OUTPUT, @ptiDebug = @tiDebug
	;
	IF @tiDebug > 0 
	BEGIN
