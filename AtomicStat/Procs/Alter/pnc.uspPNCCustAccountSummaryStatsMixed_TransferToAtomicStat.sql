...
GO
/****************************************************************************************
	Name: uspPNCCustAccountSummaryStatsMixed_TransferToAtomicStat
	Generator executed by: VALIDRS\LWhiting
	Generated code version: 1AB9BFFA-109B-422C-80C7-ADE46F984FB0
...
*****************************************************************************************/
ALTER   PROCEDURE [pnc].[uspPNCCustAccountSummaryStatsMixed_TransferToAtomicStat]
	(
...
BEGIN
	...
	IF @iPNCBatchDataSetRefreshLogId IS NOT NULL 
		--AND EXISTS( SELECT 'X' FROM DHayes.dbo.PNCCustAccountSummaryStatsFullSet x WHERE x.PNCBatchId = pnc.ufnPNCBatchGetByStatBatchLogId( @siStatBatchLogId ) )
