...
GO
/****************************************************************************************
	Name: uspPNCKCPTrxnStatsDelta_164_TransferToAtomicStat
	Generator executed by: VALIDRS\LWhiting
	Generated code version: FFF686D1-D2EF-4AE9-B5C6-5F75B6E1B8A2
	Generation set version: 44F1427E-C439-4C84-8880-74EBFF6FC70A
	Description: Upsert pnc.KCPBulk from the relevant unpivoted stats of PNCKCPTrxnStatsDelta.
		
	History:
		2019-08-19 - VALIDRS\LWhiting - Created via generator.
*****************************************************************************************/
ALTER   PROCEDURE [pnc].[uspPNCKCPTrxnStatsDelta_164_TransferToAtomicStat]
	(
...
BEGIN
	...
	BEGIN -- are there rows to process?
		...
		FROM [pnc].[ufnPNCKCPTrxnStatsDelta_164_TranslateRowToCell]( @siStatBatchLogId ) t
