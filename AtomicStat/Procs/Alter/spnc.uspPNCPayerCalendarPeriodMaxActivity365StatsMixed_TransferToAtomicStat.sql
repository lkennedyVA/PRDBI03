...
GO
/****************************************************************************************
	Name: uspPNCPayerCalendarPeriodMaxActivity365StatsMixed_TransferToAtomicStat
	Generator executed by: VALIDRS\LWhiting
	Generated code version: E98C9B47-EDC4-4C9A-BA5C-DDB4B9089CCC
...
*****************************************************************************************/
ALTER   PROCEDURE [pnc].[uspPNCPayerCalendarPeriodMaxActivity365StatsMixed_TransferToAtomicStat]
	(
...
BEGIN
	...
	IF @iPNCBatchDataSetRefreshLogId IS NOT NULL 
		--AND EXISTS( SELECT 'X' FROM DHayes.dbo.PNCPayerCalendarPeriodMaxActivity365StatsFullSet x WHERE x.PNCBatchId = pnc.ufnPNCBatchGetByStatBatchLogId( @siStatBatchLogId ) )
