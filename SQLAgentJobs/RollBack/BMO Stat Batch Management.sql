...
/****** Object:  Job [BMO Stat Batch Management]    Script Date: 9/19/2024 8:11:20 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 9/19/2024 8:11:20 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Process Monitor: Initialize]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Promote Deltas]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Returns and deposits - Watch for an available FileSet]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Returns and deposits - Stat generation]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Invoke job on [RptDb3\PrdBi02]: "PrdTrx01 FiServ BMO EligibleReturnsDaily"]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Send "FiServ BMO EligibleReturnsDaily" Problem Notification]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Returns and deposits - update statistics for BMORisk.dbo.StatExportBulk]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Returns and deposits - Transfer to [AtomicStat]]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Promote Deltas - Returns and deposits - no table truncates]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Multi Customer Account file]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Accounts - Watch for an available FileSet]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Accounts - Stat generation]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Accounts - update statistics for BMORisk.dbo.StatExportBulk]    Script Date: 9/19/2024 8:11:20 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Accounts - Transfer to [AtomicStat]]    Script Date: 9/19/2024 8:11:21 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Promote Deltas - post Accounts]    Script Date: 9/19/2024 8:11:21 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Invoke Job 'DatabaseBackup - BMO - FULL']    Script Date: 9/19/2024 8:11:21 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [End of Core Job Steps]    Script Date: 9/19/2024 8:11:21 AM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Send Problem Notification]    Script Date: 9/19/2024 8:11:21 AM ******/
